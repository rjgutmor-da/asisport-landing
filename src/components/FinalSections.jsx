...
export const FinalCTA = () => {
  return (
    <section className="py-14 bg-primary text-white text-center rounded-t-[3rem] shadow-2xl relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center">
          <a 
            ...
            className="inline-flex items-center justify-center px-8 py-4 text-xl font-bold text-primary transition-all duration-300 bg-white rounded-2xl hover:bg-gray-50 hover:shadow-2xl hover:-translate-y-1 focus:outline-none focus:ring-4 focus:ring-white/50 mb-2"
          >
             Enviar Solicitud
  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left text-sm text-gray-400 font-medium">
          <a 
