...
export default function VideoDemo() {
  return (
    <div className="w-full max-w-3xl mx-auto mt-12 animate-fade-in" style={{ animationDelay: '0.4s' }}>
      <p className="text-center text-base sm:text-lg md:text-xl text-[var(--color-text-sec)] mb-4 font-medium">
        En menos de 7 minutos descubre cómo un software puede ayudarte
      </p>
