...
const CACHE_KEY = 'saasport_metrics_cache_v6';
...
export async function getTestimonialMetrics() {
  try {
    ...
    return {
      'Planeta FC': { alumnos: 315, usuarios: 9, cobros: 839 + 249 },
      'El Cañito': { alumnos: 196, usuarios: 11, cobros: 65 + 249 },
      'Inter Stars Santa Cruz': { alumnos: 468, usuarios: 15, cobros: 1357 + 249 }
    };
  }
}
